...
# 1) Charge les données brutes pour eye-to-hand
try:
...
# 2) Préparer les données pour calibrateHandEye (AX=XB) - EYE-TO-HAND
# For eye-to-hand: A = T_gripper2base, B = T_target2cam, X = T_base2camera
...
# 3) Calibre en mode Tsai–Lenz (AX=XB, X is T_base2camera for eye-to-hand)
# A = T_gripper2base, B = T_target2cam, X = T_base2camera
