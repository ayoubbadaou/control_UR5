...
# ==================== CONFIGURATION ====================
OPC_ENDPOINT = "opc.tcp://localhost:3012/tcp_data/"
NAMESPACE_URI = "UR5.TCPData"
POLL_INTERVAL = 0.3  # Faster than server polling
# ======================================================

class TcpTableMonitor:
    def __init__(self):
        ...
        try:
            ...
            while True:
                ...
                if current_count > self.last_row_count:
                    ...
                    print(f"\n{datetime.now().strftime('%H:%M:%S')} - New {len(new_rows)} row(s) added to tcp_pose table:")
