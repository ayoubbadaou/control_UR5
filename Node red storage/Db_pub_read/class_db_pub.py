...
class DbToOPCUA:
    def __init__(self,OPC_ENDPOINT = "opc.tcp://localhost:3010/cam_data/",DB_PATH = "/home/robot/Bureau/Node-red_storage/mydata.db", NAMESPACE_URL = "UR5.CAMData", TABLE_NAME = "camera_pose"):
        self.db_path = DB_PATH
        self.opc_endpoint = OPC_ENDPOINT
        self.namespace_uri = NAMESPACE_URL
    ...
    def initialize_opcua_server(self):
        ...
        table_node = objects.add_object(idx, "CAMPoseTable")
...
def main():
    ...
    bridge = DbToOPCUA(OPC_ENDPOINT = "opc.tcp://localhost:3010/cam_data/",TABLE_NAME = "sensor_data")
    bridge.publish()
